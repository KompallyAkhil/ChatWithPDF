                ...
                <div className="innercontainer">
                    <Form.Floating className="mb-6">
                        <Form.Control
                            ...
                            type="email"
                            placeholder="name@example.com" className="inputs" name="LoginUsername" value={Login.LoginUsername} onChange={LoginData} required autoFocus
                        />
                    ...
                    <Form.Floating>
                        <Form.Control
                            ...
                            type="password"
                            placeholder="Password" className="inputs" name="LoginPassword" value={Login.LoginPassword} onChange={LoginData} required
                        />
