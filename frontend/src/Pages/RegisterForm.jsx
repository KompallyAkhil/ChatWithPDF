...
const RegisterForm = () => {
  ...
  function EmailValidate(RegisteredEmail){
    const keys =  /^[a-zA-Z0-9.!#$%&'*+/=?^_`{|}~-]+@[a-zA-Z0-9-]+(?:\.[a-zA-Z0-9-]+)*$/;
  ...
  function RegisterEvent(event) {
    if (RegisterForm.RegisteredFullName === "" || RegisterForm.RegisteredFullName === null) {
    ...
    if (RegisterForm.RegisteredFullName.length < 5){
     ...
     if (RegisterForm.RegisteredUsername === "" || RegisterForm.RegisteredUsername === null){
    ...
    if (RegisterForm.RegisteredEmail === "" || RegisterForm.RegisteredEmail === null){
    ...
    if (RegisterForm.RegisteredPassword === "" || RegisterForm.RegisteredPassword === null){
      toast.warn("Password cannot be empty");
      event.preventDefault();
      return;
    }
    if (RegisterForm.RegisteredConfirmPassword === "" || RegisterForm.RegisteredConfirmPassword === null || RegisterForm.RegisteredPassword !== RegisterForm.RegisteredConfirmPassword){
      toast.warn("Password doesnot match")
      event.preventDefault();
      return;
    }
    if(RegisterForm.RegisteredGender === "" || RegisterForm.RegisteredGender === null){
    ...
    <>
      <div className="registercontainer">
        ...
        <div className="registerinnercontainer">
          <div className="topcontainer">
            <Form.Floating className="mb-3 custom-width">
              <Form.Control
                ...
                onChange={RegisteredData} autoFocus
              />
          ...
          <Form.Select aria-label="Default select example" name="RegisteredGender" value={RegisterForm.RegisteredGender} onChange={RegisteredData} className="register">
          ...
          <div className="existingacc">
            ...
            <Link to="/Login"><p className="newuser">Sign In</p></Link>
          </div>
        </div>
      </div>
    </>
